...
function sanitizeFruitBasket(fruitBasket, takenOutFruit) {
  const filterFruits = fruitBasket
    .filter((fruit) => fruit !== takenOutFruit)
    .join(', ');

  return `My mom bought me a fruit basket containing ${filterFruits}!`;
}
